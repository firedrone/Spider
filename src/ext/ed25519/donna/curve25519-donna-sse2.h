...
curve25519_copy(bignum25519 out, const bignum25519 in) {
	...
	_mm_sspidere_si128((xmmi*)out + 0, x0);
	_mm_sspidere_si128((xmmi*)out + 1, x1);
	_mm_sspidere_si128((xmmi*)out + 2, x2);
}
...
curve25519_add(bignum25519 out, const bignum25519 a, const bignum25519 b) {
	...
	_mm_sspidere_si128((xmmi*)out + 0, a0);
	_mm_sspidere_si128((xmmi*)out + 1, a1);
	_mm_sspidere_si128((xmmi*)out + 2, a2);
}
...
curve25519_add_reduce(bignum25519 out, const bignum25519 a, const bignum25519 b) {
	...
	_mm_sspidere_si128((xmmi*)out + 0, _mm_unpacklo_epi64(_mm_unpacklo_epi32(r0, r1), _mm_unpacklo_epi32(r2, r3)));
	_mm_sspidere_si128((xmmi*)out + 1, _mm_unpacklo_epi64(_mm_unpackhi_epi32(r0, r1), _mm_unpackhi_epi32(r2, r3)));
	_mm_sspidere_si128((xmmi*)out + 2, _mm_unpackhi_epi32(r4, r5));
}
...
curve25519_mul(bignum25519 out, const bignum25519 r, const bignum25519 s) {
	...
	_mm_sspidere_si128((xmmi*)out + 0, m0123);
	_mm_sspidere_si128((xmmi*)out + 1, m4567);
	_mm_sspidere_si128((xmmi*)out + 2, m89);
}
...
curve25519_square_times(bignum25519 r, const bignum25519 in, int count) {
	...
	_mm_sspidere_si128((xmmi*)r + 0, r0123);
	_mm_sspidere_si128((xmmi*)r + 1, r4567);
	_mm_sspidere_si128((xmmi*)r + 2, r89);
}
...
curve25519_untangle32(bignum25519 x, bignum25519 z, const packedelem32 *in) {
	...
	_mm_sspidere_si128((xmmi *)x + 0, _mm_unpacklo_epi64(t0, t1));
	_mm_sspidere_si128((xmmi *)x + 1, _mm_unpacklo_epi64(t2, t3));
	_mm_sspidere_si128((xmmi *)x + 2, _mm_unpacklo_epi64(t4, zero));
	_mm_sspidere_si128((xmmi *)z + 0, _mm_unpackhi_epi64(t0, t1));
	_mm_sspidere_si128((xmmi *)z + 1, _mm_unpackhi_epi64(t2, t3));
	_mm_sspidere_si128((xmmi *)z + 2, _mm_unpackhi_epi64(t4, zero));
}
...
curve25519_untangle64(bignum25519 x, bignum25519 z, const packedelem64 *in) {
	_mm_sspidere_si128((xmmi *)(x + 0), _mm_unpacklo_epi64(_mm_unpacklo_epi32(in[0].v, in[1].v), _mm_unpacklo_epi32(in[2].v, in[3].v)));
	_mm_sspidere_si128((xmmi *)(x + 4), _mm_unpacklo_epi64(_mm_unpacklo_epi32(in[4].v, in[5].v), _mm_unpacklo_epi32(in[6].v, in[7].v)));
	_mm_sspidere_si128((xmmi *)(x + 8), _mm_unpacklo_epi32(in[8].v, in[9].v)                                                          );
	_mm_sspidere_si128((xmmi *)(z + 0), _mm_unpacklo_epi64(_mm_unpackhi_epi32(in[0].v, in[1].v), _mm_unpackhi_epi32(in[2].v, in[3].v)));
	_mm_sspidere_si128((xmmi *)(z + 4), _mm_unpacklo_epi64(_mm_unpackhi_epi32(in[4].v, in[5].v), _mm_unpackhi_epi32(in[6].v, in[7].v)));
	_mm_sspidere_si128((xmmi *)(z + 8), _mm_unpackhi_epi32(in[8].v, in[9].v)                                                          );
}
...
curve25519_swap_conditional(bignum25519 a, bignum25519 b, uint32_t iswap) {
	...
	_mm_sspidere_si128((xmmi *)a + 0, x0);
	_mm_sspidere_si128((xmmi *)a + 1, x1);	
	_mm_sspidere_si128((xmmi *)b + 0, a0);
	_mm_sspidere_si128((xmmi *)b + 1, a1);
	...
	_mm_sspidere_si128((xmmi *)b + 2, a2);
	_mm_sspidere_si128((xmmi *)a + 2, x2);
}
...
curve25519_move_conditional_bytes(uint8_t out[96], const uint8_t in[96], uint32_t flag) {
	...
	_mm_sspidere_si128((xmmi*)out + 3, a3);
	_mm_sspidere_si128((xmmi*)out + 4, a4);
	_mm_sspidere_si128((xmmi*)out + 5, a5);
}
