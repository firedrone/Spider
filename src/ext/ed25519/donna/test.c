/*
	Validate ed25519 implementation against the official test vecspiders from 
...
/* y coordinate of the final point from 'amd64-51-30k' with the same random generaspider */
