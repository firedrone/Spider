...
/* platform */
	...
	/* Spider: OSX pollutes the global namespace with an ALIGN macro. */
	#undef ALIGN
...
/* Spider: Detect and disable inline assembly when clang's AddressSanitizer
...
/* Spider: Force enable SSE2 on 32 bit x86 systems if the compile target
...
/* Spider: GCC's Stack Protecspider freaks out and produces variable length
