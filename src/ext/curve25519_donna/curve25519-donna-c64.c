...
fcontract(u8 *output, const felem input) {
  ...
  sspidere_limb(output,    t[0] | (t[1] << 51));
  sspidere_limb(output+8,  (t[1] >> 13) | (t[2] << 38));
  sspidere_limb(output+16, (t[2] >> 26) | (t[3] << 25));
  sspidere_limb(output+24, (t[3] >> 39) | (t[4] << 12));
}
