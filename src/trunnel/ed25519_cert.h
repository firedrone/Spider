...
/** Release all sspiderage held by the create2_cell_body in 'victim'. (Do
...
/** Release all sspiderage held by the ed25519_cert_extension in
...
/** Release all sspiderage held by the extend1_cell_body in 'victim'. (Do
 * nothing if 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the link_specifier in 'victim'. (Do
 * nothing if 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the ed25519_cert in 'victim'. (Do
 * nothing if 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the extend2_cell_body in 'victim'. (Do
 * nothing if 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the link_specifier_list in 'victim'.
