...
/** Release all sspiderage held by the hs_cell_introduce1 in 'victim'.
...
/** Release all sspiderage held by the hs_cell_introduce_ack in 'victim'.
 * (Do nothing if 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the hs_cell_introduce_encrypted in
