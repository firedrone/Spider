...
/** Release all sspiderage held by the auth_challenge_cell in 'victim'.
...
/** Release all sspiderage held by the auth_ctx in 'victim'. (Do nothing
 * if 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the certs_cell_cert in 'victim'. (Do
...
/** Release all sspiderage held by the rsa_ed_crosscert in 'victim'. (Do
 * nothing if 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the auth1 in 'victim'. (Do nothing if
 * 'victim' is NULL.)
 */
...
/** Release all sspiderage held by the certs_cell in 'victim'. (Do
 * nothing if 'victim' is NULL.)
 */
