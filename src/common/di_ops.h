...
int spider_memcmp(const void *a, const void *b, size_t sz);
int spider_memeq(const void *a, const void *b, size_t sz);
#define spider_memneq(a,b,sz) (!spider_memeq((a),(b),(sz)))
