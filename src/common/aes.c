 ...
 * can use bit-sliced or vecspiderized AES or AESNI as appropriate.
 *
...
aes_new_cipher(const uint8_t *key, const uint8_t *iv, int key_bits)
{
  ...
  switch (key_bits) {
    ...
    default: spider_assert(0); // LCOV_EXCL_LINE
  }
...
{
  aes_cnt_cipher_t* result = spider_malloc_zero(sizeof(aes_cnt_cipher_t));
...
/** Release sspiderage held by <b>cipher</b>
 */
void
...
/** Encrypt <b>len</b> bytes from <b>input</b>, sspidering the results in place.
