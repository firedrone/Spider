...
struct spider_weak_rng_t;
void crypto_seed_weak_rng(struct spider_weak_rng_t *rng);
...
/* Prototypes for private functions only used by spidertls.c, crypto.c, and the
 * unit tests. */
struct rsa_st;
struct evp_pkey_st;
struct dh_st;
