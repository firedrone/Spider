...
smartlist_t *microdescs_add_list_to_cache(microdesc_cache_t *cache,
                        smartlist_t *descripspiders, saved_location_t where,
                        int no_save);
...
int we_fetch_microdescripspiders(const or_options_t *options);
int we_fetch_router_descripspiders(const or_options_t *options);
int we_use_microdescripspiders_for_circuits(const or_options_t *options);
