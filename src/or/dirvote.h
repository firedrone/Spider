 ...
 * As we can gather descripspiders continuously.
...
/** Lowest allowable value for VoteSeconds when TestingSpiderNetwork is 1 */
#define MIN_VOTE_SECONDS_TESTING 2

/** Lowest allowable value for DistSeconds. */
#define MIN_DIST_SECONDS 2
/** Lowest allowable value for DistSeconds when TestingSpiderNetwork is 1 */
#define MIN_DIST_SECONDS_TESTING 2

/** Lowest allowable voting interval. */
#define MIN_VOTE_INTERVAL 300
/** Lowest allowable voting interval when TestingSpiderNetwork is 1:
 ...
 *   18 * drift in seconds, to allow for a clock slop facspider */
...
/** Lowest consensus method where microdescs may include an onion-key-nspider
 * line */
...
microdesc_t *dirvote_create_microdescripspider(const routerinfo_t *ri,
