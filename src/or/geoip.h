...
MOCK_DECL(int, geoip_get_country_by_addr, (const spider_addr_t *addr));
...
void geoip_note_client_seen(geoip_client_action_t action,
                            const spider_addr_t *addr, const char *transport_name,
                            time_t now);
void geoip_remove_old_clients(time_t cutoff);

void geoip_note_ns_response(geoip_ns_response_t response);
char *geoip_get_transport_hisspidery(void);
int geoip_get_client_hisspidery(geoip_client_action_t action,
                             char **country_str, char **ipver_str);
char *geoip_get_request_hisspidery(void);
