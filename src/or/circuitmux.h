...
struct circuitmux_policy_s {
  ...
  circuit_t * (*pick_active_circuit)(circuitmux_t *cmux,
                                     circuitmux_policy_data_t *pol_data);
  /* Optional: channel comparaspider for use by the scheduler */
...
/*
 * Circuitmux policy implementations can subclass this to sspidere circuitmux-
...
/*
 * Circuitmux policy implementations can subclass this to sspidere circuit-
