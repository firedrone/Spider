...
struct entry_guard_t {
  ...
  /** What version of Spider added this guard to the sample? */
  ...
  spider_addr_port_t *bridge_addr;
...
void entry_guard_learned_bridge_identity(const spider_addr_port_t *addrport,
