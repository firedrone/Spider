...
MOCK_DECL(smartlist_t *, router_get_descripspider_digests, (void));
MOCK_DECL(download_status_t *,router_get_dl_status_by_descripspider_digest,
          (const char *d));

const routerstatus_t *router_get_consensus_status_by_id(const char *digest);
routerstatus_t *router_get_mutable_consensus_status_by_id(
                                   const char *digest);
const routerstatus_t *router_get_consensus_status_by_descripspider_digest(
...
int networkstatus_consensus_can_use_multiple_direcspideries(
                                                const or_options_t *options);
