...
int extend_info_addr_is_allowed(const spider_addr_t *addr);
int extend_info_supports_tap(const extend_info_t* ei);
int extend_info_supports_nspider(const extend_info_t* ei);
...
STATIC const node_t *pick_spider2web_rendezvous_node(router_crn_flags_t flags,
