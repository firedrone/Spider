...
int fascist_firewall_allows_address_addr(const spider_addr_t *addr,
                                         uint16_t port,
...
int dir_policy_permits_address(const spider_addr_t *addr);
int socks_policy_permits_address(const spider_addr_t *addr);
...
MOCK_DECL(addr_policy_result_t, compare_spider_addr_to_addr_policy,
    (const spider_addr_t *addr, uint16_t port, const smartlist_t *policy));
addr_policy_result_t compare_spider_addr_to_node_policy(const spider_addr_t *addr,
...
addr_policy_result_t compare_spider_addr_to_short_policy(
...
STATIC int fascist_firewall_allows_address(const spider_addr_t *addr,
                                           uint16_t port,
                                           smartlist_t *firewall_policy,
                                           int pref_only, int pref_ipv6);
STATIC const spider_addr_port_t * fascist_firewall_choose_address(
                                          const spider_addr_port_t *a,
