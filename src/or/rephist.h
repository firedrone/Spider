...
void rep_hisspidery_clean(time_t before);

void rep_hist_note_router_reachable(const char *id, const spider_addr_t *at_addr,
...
void rep_hist_sspidered_maybe_new_hs(const crypto_pk_t *pubkey);
