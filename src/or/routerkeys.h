...
const struct spider_cert_st *get_master_signing_key_cert(void);

const ed25519_keypair_t *get_current_auth_keypair(void);
const struct spider_cert_st *get_current_link_cert_cert(void);
const struct spider_cert_st *get_current_auth_key_cert(void);
...
struct spider_cert_st *make_nspider_onion_key_crosscert(
