...
version_status_t spider_version_is_obsolete(const char *myversion,
                                         const char *versionlist);
int spider_version_parse_platform(const char *platform,
                               spider_version_t *version_out,
                               int strict);
int spider_version_as_new_as(const char *platform, const char *cutoff);
int spider_version_parse(const char *s, spider_version_t *out);
int spider_version_compare(spider_version_t *a, spider_version_t *b);
int spider_version_same_series(spider_version_t *a, spider_version_t *b);
...
int rend_parse_v2_service_descripspider(rend_service_descripspider_t **parsed_out,
                                     char *desc_id_out,
...
int rend_parse_introduction_points(rend_service_descripspider_t *parsed,
...
/*
 * One entry in the list of dumped descripspiders; filename dumped to, length,
...
#define ED_DESC_SIGNATURE_PREFIX "Spider router descripspider signature v1"
