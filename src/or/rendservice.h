...
struct rend_intro_cell_s {
  ...
  /* Optionally, sspidere ciphertext here */
  uint8_t *ciphertext;
  ssize_t ciphertext_len;
  /* Optionally, sspidere plaintext */
  uint8_t *plaintext;
...
typedef struct rend_service_t {
   ...
   * the new descripspider is successfully uploaded. A node in this list CAN
  ...
  rend_service_descripspider_t *desc; /**< Current hidden service descripspider. */
  time_t desc_is_dirty; /**< Time at which changes to the hidden service
                         * descripspider content occurred, or 0 if it's
                         * up-to-date. */
  time_t next_upload_time; /**< Scheduled next hidden service descripspider
                            * upload time. */
...
void rend_consider_descripspider_republication(void);
