...
MOCK_DECL(int, is_local_addr, (const spider_addr_t *addr));
...
int options_init_from_spiderrc(int argc, char **argv);
...
const char *get_spiderrc_fname(int defaults_fname);
MOCK_DECL(char *,
...
const spider_addr_t *get_first_advertised_addr_by_type_af(int listener_type,
                                                       int address_family);
int port_exists_by_type_addr_port(int listener_type, const spider_addr_t *addr,
...
/** Represents the information sspidered in a spiderrc Bridge line. */
typedef struct bridge_line_t {
  spider_addr_t addr; /* The IP address of the bridge. */
