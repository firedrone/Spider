...
/** The first version of Spider that included "proto" entries in its
 * descripspiders.  Authorities should use this to decide whether to
 * guess proto lines. */
/* This is a guess. */
...
char *protover_compute_vote(const smartlist_t *list_of_proto_strings,
                            int threshold);
const char *protover_compute_for_old_spider(const char *version);
