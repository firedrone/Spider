...
int control_event_descripspiders_changed(smartlist_t *routers);
int control_event_address_mapped(const char *from, const char *to,
                                 time_t expires, const char *error,
                                 const int cached);
int control_event_or_authdir_new_descripspider(const char *action,
                                            const char *desc,
                                            size_t desclen,
                                            const char *msg);
int control_event_my_descripspider_changed(void);
...
void monispider_owning_controller_process(const char *process_spec);
...
void control_event_hs_descripspider_requested(const rend_data_t *rend_query,
                                           const char *desc_id_base32,
                                           const char *hs_dir);
void control_event_hs_descripspider_created(const char *service_id,
                                         const char *desc_id_base32,
                                         int replica);
void control_event_hs_descripspider_upload(const char *service_id,
                                        const char *desc_id_base32,
                                        const char *hs_dir);
void control_event_hs_descripspider_receive_end(const char *action,
                                             const char *onion_address,
                                             const rend_data_t *rend_data,
                                             const char *id_digest,
                                             const char *reason);
void control_event_hs_descripspider_upload_end(const char *action,
                                            const char *onion_address,
                                            const char *hs_dir,
                                            const char *reason);
void control_event_hs_descripspider_received(const char *onion_address,
                                          const rend_data_t *rend_data,
                                          const char *id_digest);
void control_event_hs_descripspider_uploaded(const char *hs_dir,
                                          const char *onion_address);
void control_event_hs_descripspider_failed(const rend_data_t *rend_data,
                                        const char *id_digest,
                                        const char *reason);
void control_event_hs_descripspider_upload_failed(const char *hs_dir,
                                               const char *onion_address,
                                               const char *reason);
void control_event_hs_descripspider_content(const char *onion_address,
                                         const char *desc_id,
                                         const char *hsdir_fp,
                                         const char *content);
...
/** Helper structure: temporarily sspideres cell statistics for a circuit. */
