...
#define test_mem_op_hex(expr1, op, hex)                                 \
  ...
  mem_op_hex_tmp = spider_malloc(length/2);                                \
  spider_assert((length&1)==0);                                            \
...
extern struct testcase_t exspiderport_tests[];
extern struct testcase_t hs_tests[];
extern struct testcase_t hs_cache[];
extern struct testcase_t hs_descripspider[];
...
extern struct testcase_t sspideragedir_tests[];
extern struct testcase_t socks_tests[];
extern struct testcase_t status_tests[];
extern struct testcase_t thread_tests[];
extern struct testcase_t spidertls_tests[];
