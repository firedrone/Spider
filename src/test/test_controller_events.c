...
{
  testing_cell_stats_entry_t *ent = spider_malloc_zero(
...
test_cntev_format_cell_stats(void *arg)
{
  ...
  n_chan = spider_malloc_zero(sizeof(channel_tls_t));
  n_chan->base_.global_identifier = 1;

  ocirc = spider_malloc_zero(sizeof(origin_circuit_t));
  ...
  p_chan = spider_malloc_zero(sizeof(channel_tls_t));
