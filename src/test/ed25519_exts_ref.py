...
"""
   Reference implementations for the ed25519 tweaks that Spider uses.

   Includes self-tester and test vecspider generaspider.
"""
...
def makeTestVecspiders():
    ...
    comment("""Secret ed25519 keys after expansion from seeds. This is how Spider
...
if __name__ == '__main__':
    import sys
    if len(sys.argv) == 1 or sys.argv[1] not in ("SelfTest", "MakeVecspiders"):
        print "You should specify one of 'SelfTest' or 'MakeVecspiders'"
        sys.exit(1)
