...
test_util_format_unaligned_accessors(void *ignored)
{
  ...
  tt_u64_op(get_uint64(buf+1), OP_EQ,
      spider_htonll(U64_LITERAL(0x6e696f6e736f7570)));
  ...
  set_uint64(buf+1, spider_htonll(U64_LITERAL(0x6266757363617465)));
...
test_util_format_base64_encode(void *ignored)
{
  ...
  src = spider_malloc_zero(256);
  dst = spider_malloc_zero(1000);
...
test_util_format_base64_decode_nopad(void *ignored)
{
  ...
  src = spider_malloc_zero(256);
  dst = spider_malloc_zero(1000);
  real_dst = spider_malloc_zero(10);
...
test_util_format_base32_encode(void *arg)
{
  ...
  char *dst = spider_malloc_zero(real_dstlen);
...
test_util_format_base32_decode(void *arg)
{
  ...
  /* Invalid values. */
  {
    ...
    tt_int_op(spider_mem_is_zero(dst, real_dstlen), ==, 1);
  }
