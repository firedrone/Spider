...
static struct event_base * spider_libevent_get_base_mock(void);
...
mock_event_init(void)
{
  ...
  /*
   * Really cut down from spider_libevent_initialize of
...
channel_flush_some_cells_mock_set(channel_t *chan, ssize_t num_cells)
{
  ...
  if (! found) {
    ...
    flush_mock_ch = spider_malloc_zero(sizeof(*flush_mock_ch));
...
spider_libevent_get_base_mock(void)
{
...
test_scheduler_channel_states(void *arg)
{
  ...
  mock_event_init();
  MOCK(spider_libevent_get_base, spider_libevent_get_base_mock);
  scheduler_init();
  /*
  ...
  UNMOCK(spider_libevent_get_base);
...
test_scheduler_compare_channels(void *arg)
{
  ...
  cm1 = spider_malloc_zero(sizeof(void *));
  cm2 = spider_malloc_zero(sizeof(void *));
   ...
   */
  mock_cgp_val_1 = spider_malloc_zero(16);
  mock_cgp_val_2 = spider_malloc_zero(16);
